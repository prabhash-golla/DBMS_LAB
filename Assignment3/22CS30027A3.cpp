...
void executeQuery(pqxx::connection &conn, const string &query,const string &Q ,const string &answerLabel) 
{
    try 
    {
        pqxx::work txn(conn);  
...
int main() 
{
    try 
    {
        pqxx::connection conn("host=10.5.18.72 dbname=22CS30027 user=22CS30027 password=5243y6!J");
